...
uint64_t bool geo::codec::decodeIntCompressorArray<long long>(VMP4Chapter*, mgcl::ints::IntDecompressor<long long>*, unsigned int, unsigned int, unsigned long, long long*)
...

{
    ...
    if (uVar2 != 0) {
        ...
        if (uVar2 < *(param_1 + 0x38) || uVar2 == *(param_1 + 0x38)) {
            *(param_1 + 0x30) = uVar2;
            iVar1 = mgcl::ints::IntDecompressor<long long>::decompress(unsigned char const*, unsigned long, int, int, unsigned long, long long*)
